...
<body>
    ...
    ?>
    <a href="" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block"><?php echo $row['name']; ?></a>
    <div class="dropdown-menu fade-up m-0">
        <?php if(isset($_SESSION['email'])) { ?>
        <a href="logout.php" class="btn btn-secondary py-4 px-lg-5 d-none d-lg-block">Logout<i class="fa fa-arrow-right ms-3"></i></a>
        <?php } ?>
    </div>
    <?php
            }
