...
<body>
    ...
    <div class="col-lg-8 " style="margin-left:350px">
                    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">Book A Waterless Car Washing Service</h1>
                        ...
                        <option value="West Bengal">West Bengal</option>
                                ...
                                <select class="form-select border-0" style="height: 55px;" name="gender" required>
                                    <option value="Choice gender"  >Choice Servies</option>
                                ...
                                <div class="col-12">
                                    <button class="btn btn-secondary w-100 py-3" type="submit" name="washbook">Book Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
