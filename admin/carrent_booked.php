    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <!-- Cars are fetch from API Integration Of All over WORLD -->


          <link rel="API" href="https://api.api-ninjas.com/v1/cars?limit=2&model=">
                       ...
                       <td>
                          <div class="d-flex align-items-center">
                            <form action="delete_config.php" method="POST">
                              ...
                              <button type="submit" name="delet4" value="DELETE"
