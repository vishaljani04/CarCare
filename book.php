    ...
    <div class="col-lg-8 " style="margin-left:350px">
                    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <form action="bookingcode.php" method="post">
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control border-0" placeholder="Your First Name" style="height: 55px;" name="name">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control border-0" placeholder="Your last name" style="height: 55px;" name="email">
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="date" id="date1" data-target-input="nearest">
                                        <!-- <input type="text"
                                            ...
                                            <input type=    "text" class="form-control border-0" placeholder="Your Mobile.no" style="height: 55px;" name="email">
                                    </div>
                                </div>
                                <div class="col-12">
                        ...
                        <option value="West Bengal">West Bengal</option>
                                ...
                                <div class="col-12">
                                <select class="form-select border-0" style="height: 55px;" name="services" required>
                                <option value="Choice Servies"  >Choice Servies</option>
                        ...
                        <option value="Door Step Service">Door Step Service</option>
                                ...
                                <div class="col-12">
                                <select class="form-select border-0" style="height: 55px;" name="services" required>
                                <option value="Choice Servies"  >Choice Servies Station</option>
                                <option value="Exterior Cleaning">PJ Servies</option>
                                <option value="Exterior Cleaning">RJ Servies</option>
                                ...
                                <div class="col-12">
                                <input type="text" class="form-control border-0" placeholder="Enter City.." style="height: 55px;" name="email">
                                </div>
                                <div class="col-12">
                                 <textarea class="form-control border-0" placeholder="Address.." name="message"></textarea>
                                </div>
                                <div class="col-12">
                                <select class="form-select border-0" style="height: 55px;" name="services" required>
                                <!-- <option value="Choice Servies"  >Choice Servies Station</option> -->
                                <option value="Exterior Cleaning" >Gender</option>
                                <option value="Exterior Cleaning">Male</option>
                                <option value="Exterior Cleaning">Female</option>
